...
from istkharxmusic.misc import SUDOERS
from istkharxmusic.utils.database import add_sudo, remove_sudo
from istkharxmusic.utils.decorators.language import language
from istkharxmusic.utils.extraction import extract_user
from istkharxmusic.utils.inline import close_markup
...
GAMDOP = "https://telegra.ph/file/cc14d740860df91dcd54a.jpg"
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("➤ 𝐓𝐞𝐫𝐢 𝐌𝐚𝐚 𝐊𝐢 𝐂𝐡𝐮𝐭𝐭 𝐒𝐚𝐥𝐞 𝐋𝐮𝐧𝐝 𝐋𝐞 𝐋𝐞 𝐈𝐬𝐭𝐤𝐡𝐚𝐫 𝐊𝐚 🖕 𝐒𝐮𝐝𝐨𝐥𝐢𝐬𝐭 𝐊𝐞 𝐁𝐚𝐝𝐥𝐞 😂😂", show_alert=True)
    else:
