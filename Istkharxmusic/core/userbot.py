...
class Userbot(Client):
    def __init__(self):
        self.one = Client(
            ...
            no_updates=False,
            plugins=dict(root="istkharxmusic.plugins.USERBOT"),
        )
        self.two = Client(
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Veena_Networks")
                await self.one.join_chat("Veena_Networks")
                await self.one.join_chat("Veena_Networks")
                await self.one.join_chat("Veena_Networks")
                await self.one.join_chat("Veena_Networks")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Veena_Networks")
                await self.two.join_chat("Veena_Networks")
                await self.two.join_chat("Veena_Networks")
                await self.two.join_chat("Veena_Networks")
                await self.two.join_chat("Veena_Networks")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Veena_Networks")
                await self.three.join_chat("Veena_Networks")
                await self.three.join_chat("Veena_Networks")
                await self.three.join_chat("Veena_Networks")
                await self.three.join_chat("Veena_Networks")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Veena_Networks")
                await self.four.join_chat("Veena_Networks")
                await self.four.join_chat("Veena_Networks")
                await self.four.join_chat("Veena_Networks")
                await self.four.join_chat("Veena_Networks")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Veena_Networks")
                await self.five.join_chat("Veena_Networks")
                await self.five.join_chat("Veena_Networks")
                await self.five.join_chat("Veena_Networks")
                await self.five.join_chat("Veena_Networks")
